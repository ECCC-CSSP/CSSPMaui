...
public partial class Startup : IStartup
{
    public async Task<bool> Generate()
    {
        ...
        string? EnumsTestGeneratedText = Configuration["EnumsTestGenerated"];
        
        if (EnumsTestGeneratedText == null)
        {
            Console.WriteLine($"{nameof(EnumsTestGeneratedText)} is null");
            return await Task.FromResult(false);
        }

        FileInfo fi = new FileInfo(EnumsTestGeneratedText);
        ...
        importAssembly = typeof(AddressTypeEnum).Assembly;
