...
public partial class CSSPFileService : ControllerBase, ICSSPFileService
{
    ...
    {
        string FunctionName = $"async Task<ActionResult<LocalFileInfo>> GetAzureFileInfoAsync(int ParentTVItemID, string FileName) - ParentTVItemID: { ParentTVItemID }  FileName: { FileName }";
        ...
        try
        {
            ...
            {
                throw new Exception("CSSPLocalLoggedInService.LoggedInContactInfo.LoggedInContact == null");
            }
