...
public partial class CSSPFileService : ControllerBase, ICSSPFileService
{
    ...
    {
        string FunctionName = $"async Task<ActionResult<bool>> CreateTempCSVAsync(TableConvertToCSVModel tableConvertToCSVModel) -- TableFileName: {tableConvertToCSVModel.TableFileName}";
