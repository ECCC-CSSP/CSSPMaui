...
public partial class CSSPReadGzFileService : ICSSPReadGzFileService
{
    ...
    {
        string FunctionName = $"async Task<bool> MergeJsonWebAllMWQMSubsectorsAsync(WebAllMWQMSubsectors? webAllMWQMSubsectors, WebAllMWQMSubsectors? webAllMWQMSubsectorsLocal)";
    ...
    {
        if (webAllMWQMSubsectorsLocal != null)
        {
