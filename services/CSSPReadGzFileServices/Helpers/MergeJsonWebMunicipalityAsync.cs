...
public partial class CSSPReadGzFileService : ICSSPReadGzFileService
{
    ...
    {
        string FunctionName = $"async Task<bool> MergeJsonWebMunicipalityAsync(WebMunicipality? webMunicipality, WebMunicipality? webMunicipalityLocal)";
