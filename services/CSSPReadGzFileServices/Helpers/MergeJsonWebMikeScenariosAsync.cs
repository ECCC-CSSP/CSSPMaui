...
public partial class CSSPReadGzFileService : ICSSPReadGzFileService
{
    ...
    {
        string FunctionName = $"async Task<bool> MergeJsonWebMikeScenariosAsync(WebMikeScenarios? webMikeScenarios, WebMikeScenarios? webMikeScenariosLocal)";
