...
public enum ReportFormattingDateEnum
{
    ReportFormattingDateYearOnly = 1,
    ReportFormattingDateMonthDecimalOnly = 2,
    ReportFormattingDateMonthShortTextOnly = 3,
    ReportFormattingDateMonthFullTextOnly = 4,
    ReportFormattingDateDayOnly = 5,
    ReportFormattingDateHourOnly = 6,
    ReportFormattingDateMinuteOnly = 7,
    ReportFormattingDateYearMonthDecimalDay = 8,
    ReportFormattingDateYearMonthShortTextDay = 9,
    ReportFormattingDateYearMonthFullTextDay = 10,
    ReportFormattingDateYearMonthDecimalDayHourMinute = 11,
    ReportFormattingDateYearMonthShortTextDayHourMinute = 12,
    ReportFormattingDateYearMonthFullTextDayHourMinute = 13,
}
public enum ReportFormattingNumberEnum
{
    ReportFormattingNumber0Decimal = 1,
    ReportFormattingNumber1Decimal = 2,
    ReportFormattingNumber2Decimal = 3,
    ReportFormattingNumber3Decimal = 4,
    ReportFormattingNumber4Decimal = 5,
    ReportFormattingNumber5Decimal = 6,
    ReportFormattingNumber6Decimal = 7,
    ReportFormattingNumberScientific0Decimal = 8,
    ReportFormattingNumberScientific1Decimal = 9,
    ReportFormattingNumberScientific2Decimal = 10,
    ReportFormattingNumberScientific3Decimal = 11,
    ReportFormattingNumberScientific4Decimal = 12,
    ReportFormattingNumberScientific5Decimal = 13,
    ReportFormattingNumberScientific6Decimal = 14,
}
...
public enum WebTypeEnum
{
    ...
    WebAllMWQMAnalysisReportParameters = 7,
    WebAllMWQMLookupMPNs = 8,
    WebAllMWQMSubsectors = 9,
    WebAllPolSourceGroupings = 10,
    WebAllPolSourceSiteEffectTerms = 11,
    WebAllProvinces = 12,
    WebAllReportTypes = 13,
    WebAllTels = 14,
    WebAllTideLocations = 15,
    WebAllSearch = 16,
    WebAllUseOfSites = 17,
    WebArea = 18,
    WebClimateSites = 19,
    ...
    WebLabSheets = 23,
    WebMikeScenarios = 24,
    WebMonitoringOtherStatsCountry = 25,
    WebMonitoringOtherStatsProvince = 26,
    WebMonitoringRoutineStatsCountry = 27,
    WebMonitoringRoutineStatsProvince = 28,
    WebMunicipality = 29,
    WebMWQMRuns = 30,
    WebMWQMSamples1980_2020 = 31,
    WebMWQMSamples2021_2060 = 32,
    WebMWQMSites = 33,
    WebPolSourceSites = 34,
    WebProvince = 35,
    WebRoot = 36,
    WebSector = 37,
    WebSubsector = 38,
